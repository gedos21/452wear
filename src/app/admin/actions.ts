...
export async function urunKaydet(_onceki: Sonuc, fd: FormData): Promise<Sonuc> {
  ...
  try {
    ...
    // Kaldırılan görseller ürün yazıldıktan SONRA silinir: yazım başarısız
    // olsaydı ürün hâlâ onları gösteriyor olurdu. Yalnızca başka ürünün
    // kullanmadığı dosyalar gider.
    if (mevcut)
